...
public interface Constants {
    ...
    String NAME_NONE = "";
    Active ACTIVE_NONE = new Active(ItemTemplate.NONE, CookedState.NONE, PreparedState.NONE,
            Material.NONE, ItemTemplate.NONE, DIFFICULTY_NONE, LOSS_NONE, RATIO_NONE, Rarity.NONE);
    ArrayList<Active> ACTIVES_NONE = new ArrayList<>(Collections.singleton(ACTIVE_NONE));
    ...
    Cooker COOKER_NONE = new Cooker(Cooker._Cooker.NONE, DIFFICULTY_NONE, Rarity.NONE);
    ArrayList<Cooker> COOKERS_NONE = new ArrayList<>(Collections.singleton(COOKER_NONE));
    Ingredient INGREDIENT_NONE = new Ingredient(ItemTemplate.NONE, CookedState.NONE, PreparedState.NONE, Material.NONE,
    ...
    ArrayList<IngredientGroup> INGREDIENT_GROUPS_NONE = new ArrayList<>(Collections.singleton(INGREDIENT_GROUP_NONE));
    MobDrop MOB_DROP_NONE = new MobDrop(Creature.NONE, Rarity.NONE);
    Result RESULT_NONE = new Result(ItemTemplate.NONE, CookedState.NONE, PreparedState.NONE,
            Material.NONE, ItemTemplate.NONE, DIFFICULTY_NONE, ItemTemplate.NONE, ItemTemplate.NONE,"",
            false);
    Target TARGET_NONE = new Target(ItemTemplate.NONE, CookedState.NONE, PreparedState.NONE,
            Material.NONE, ItemTemplate.NONE, DIFFICULTY_NONE, LOSS_NONE, RATIO_NONE, Creature.NONE, Rarity.NONE);
    ArrayList<Target> TARGETS_NONE = new ArrayList<>(Collections.singleton(TARGET_NONE));
